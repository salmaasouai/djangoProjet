# Generated by Django 4.2 on 2024-10-04 09:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reservations', models.ManyToManyField(related_name='reservations', through='Participant.Reservation', to='Conference.conference')),
